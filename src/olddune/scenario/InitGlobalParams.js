...
export class InitGlobalParams {
	...
	InitGlobalParams = function () {
		...
		InitBasaPurchaseUnitScience_ar.push(new GridCrewScience(0, 20, 20, 1, 1, 117, 53, 0, 0, 2, 2, false,
			...
			"средний танк",'/imageDune/unit/tank.jpg',"mTank"));
			...
			"осадный танк",'/imageDune/unit/siegeTank.jpg',"hTank"));
		//2, 10
		InitBasaPurchaseUnitScience_ar.push(new GridCrewScience(2, 10, 10, 1, 1, 40, 40, 2, .4, .4, 1, true,
			...
			"пехота",'/imageDune/unit/soldier.jpg',"infant"));
			...
			"багги",'/imageDune/unit/baggy.jpg',"car"));
			...
			"ракетный танк",'/imageDune/unit/rocketTank.jpg',"rTank"));
			...
			"амфибия",'/imageDune/unit/top.png',"amfib"));
			...
			"самолет",'/imageDune/unit/top.png',"fly"));
